package org.ifaster.rocketmq.spring.configuration;

import org.ifaster.rocketmq.spring.cycle.LifeCycle;
 ...
 */
@Configuration
public class BootStrapConfigure implements ApplicationListener<ContextRefreshedEvent> {
